...
name = "oi"
generated = 100
date=[datetime.datetime(2019, 6, (1+int(i/24)),(i%24),00) for i in range(generated)]
samples=[]
stndr=[]
for i in range(generated):
	...
	stndr.append(np.std(nn))
	samples.append(np.mean(nn))

g = graph.Graph(samples, stndr, date, name)
